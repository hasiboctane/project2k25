                            ...
                            <div class="col-md-6">
                                <div class="blog_post p-3 p-lg-4 card h-100 bg-transparent shadow-sm border-opacity-10">
                                    <div class="blog_img mb-4 position-relative">
                                        <a href="details.html">
                                            <img class="img-fluid rounded z-3" src="assets/frontend/images/blog/car.jpg"
                                                alt="Health & Wellness">
                                        </a>
                                    </div>
                                        ...
                                        <div class="short_info d-sm-flex align-items-center mb-3">
                                            <div class="mb-2 mb-sm-0 me-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="icon me-1">
                                                        <img src="assets/frontend/images/tag.svg" alt="Tag">
                                                    </div>
                                            ...
                                            <div class="mb-2 mb-sm-0 me-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="icon me-1">
                                                        <img src="assets/frontend/images/calendar.svg" alt="Date">
                                                    </div>
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center">
                                                    <div class="icon me-1">
                                                        <img src="assets/frontend/images/eye.svg" alt="View">
                                                    </div>
