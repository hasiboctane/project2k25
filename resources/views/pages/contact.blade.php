        ...
        <div class="container">
            <div class="row gy-3 mb-5 justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="contact_item shadow-sm d-flex align-items-center">
                        <div class="contact_icon me-3">
                            <img src="assets/frontend/images/icons/phone-dark.svg" alt="Phone">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="contact_item shadow-sm d-flex align-items-center">
                        <div class="contact_icon me-3">
                            <img src="assets/frontend/images/icons/email-dark.svg" alt="Email">
                        </div>
                        <div class="contact_body">
                ...
                <div class="col-xl-4 col-md-8">
                    <div class="contact_item shadow-sm d-flex align-items-center">
                        <div class="contact_icon me-3">
                            <img src="assets/frontend/images/icons/location.svg" alt="Address">
                        </div>
                        <div class="contact_body">
