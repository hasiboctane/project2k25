                    ...
                    <form action="#" method="post">
                        <div class="input-group">
                            ...
                            <button type="submit" class="input-group-text bg-primary border-primary text-white">
                                Subscribe
                                <img src="assets/frontend/images/icons/subscribe.svg" alt="Subscribe">
                            </button>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="footer_widget">
                            ...
                            <div class="mb-4">
                                <div class="site_info d-flex align-items-center mb-4">
                                    <div class="me-2">
                                        <img src="assets/frontend/images/icons/phone.svg" alt="For Support">
                                    </div>
                                    <div>
                                        <h5>For Support</h5>
                                ...
                                <div class="site_info d-flex align-items-center mb-4">
                                    <div class="me-2">
                                        <img src="assets/frontend/images/icons/email.svg" alt="Send Us Email">
                                    </div>
                                    <div>
                                        <h5>Send Us Email</h5>
